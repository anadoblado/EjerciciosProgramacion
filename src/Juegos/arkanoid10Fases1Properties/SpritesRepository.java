...
public class SpritesRepository {
	...
	public static String GAME_OVER = "game-over.png";
	public static String VIDAS = "nave-25x7.png";
	public static String FONDO = miEjemplo.getProperty("CARGAR_FONDO");
